...
import useGlobalSettingStore from "@/store/globalStore";
...
const Header = () => {
  ...
  const toggleThemeMode = () => {
    setCookie("theme", !globalStore.darkMode);
    document.documentElement.setAttribute(
      "data-theme",
      !globalStore.darkMode ? "night" : "light"
    );
    ...
    <header>
      <div className="navbar bg-base-100 shadow">
        ...
        <div className="navbar-center">
          <Link href="/" className=" btn-ghost text-xl font-bold italic">
            Movie Master
          </Link>
        </div>
        <div className="navbar-end md:no-wrap wrap">
          <form className="md:block hidden" onSubmit={handleSubmit((val)=>searchNow(val))}>
            <input
              ...
              {...register("search", {
                ...
                validate: {
                  minLength: (v) => (v && v.length >= 2) || "Too short",
                },
              })}
            ...
            {errors.search && (
              <span className="text-red-500 block">
                {errors?.search?.message || "This field is required"}
              </span>
            )}
          </form>
          <button className="btn btn-ghost btn-circle">
            <label className="swap swap-rotate">
              ...
              <input
                ...
                value={globalStore.darkMode ? "night" : "light"}
              />
          ...
          <Link href="/watchlist" className="btn btn-ghost btn-circle">
